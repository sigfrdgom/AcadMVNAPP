...
cd /var/lib/jenkins/workspace/sigfridPipeline/proyecto/CasosAcadAppMvn-ear/target/
cp CasosAcadAppMvn-ear-1.0-SNAPSHOT.ear /var/lib/jenkins/workspace/sigfridPipeline/compose/glassfish/
echo copio el ear
